                            ...
                            <div class="col-md-6 col-12 mx-auto">
                                ...
                                <form:form class="row" method="post" action="/admin/order/update" 
                                    ...
                                    <div class="mb-3 col-12 col-md-6">
                                      <label for="exampleInputEmail1">Account Authorization:</label>
                                      <input type="text" value="${newOrder.user.role.name}" class="form-control" disabled="true"/>
                                    </div>
   
                                      <div class="mb-3 col-12 col-md-6">
                                          <label class="form-label">Status:</label>
                                          <form:select class="form-select form-select-md mb-3" path="status">
                                              <option selected>Open this select menu</option>
                                              <form:option value="PENDING" >PENDING</form:option>
                                              <form:option value="SHIPPING">SHIPPING</form:option>
                                              <form:option value="COMPLETELY">COMPLETELY</form:option>
