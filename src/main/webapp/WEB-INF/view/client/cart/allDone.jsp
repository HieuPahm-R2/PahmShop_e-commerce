...
<head>
    ...
    <link rel="stylesheet" href="/client/css/doneOrder.css">
</head>
<body>
    <!-- start of nav -->
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <!-- start of main -->
  <div style="background:rgb(209, 179, 134)">
  <div class="container">
        ...
        <div class="success-container">
          ...
          <br>
            ...
            <div class="confirm-green-box">
              ...
              <p>Thank you for choosing PahmStudio. You will shortly receive a confirmation email.</p>
            </div>
  
          <br>
           <a href="/">
            <button id="create-btn" class="btn btn-ouioui-secondary margin-left-5px">Back to shop</button>
           </a> 
        </div>
          </div>
      </div>
